...
public class AuthController {
	...
	@Operation(summary= "REGISTRAZIONE",description="Registra un account nel db")
	@ApiResponse(responseCode = "200" ,description = "Registrazione effettuata")
	@ApiResponse(responseCode = "500" , description = "Errore nel server")
	@PostMapping("/signIn")
	public ResponseEntity<Object> signIn(@RequestBody RegisterRequest register){
		us.registerUser(register);
